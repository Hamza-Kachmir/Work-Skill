    ...
    <div class="panel-container">
        <div class="search">
            <form action="" method="post">
                <div class="border-search">
                    <div class="barsearch">
                        ...
                        <input id="search" type="search" name="user" hx-post="searchusers.php" h hx-trigger="keyup changed delay:400ms, search" hx-target=".resultusers" autocomplete="off">
                    </div>
                </div>
            ...
            <div class="resultusers">
                ...
                if (empty($_POST["user"])) {
                    $filter = "nom";
                    $sql2 = "SELECT * FROM utilisateurs ORDER BY :filter";
        ...
        <a class="btn-search test" href="panel.php">Panel précédent</a>
    </div>
</main>
