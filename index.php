...
require "assets/core/Underskill-class.php";
...
<main id="index">
  <div class="logo">
    <svg version="1.1" id="Calque_2" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 1000 1000" style="enable-background: new 0 0 1000 1000" xml:space="preserve">
      <path class="st1" d="M372.22,937.82L17.67,795.3c-1.56-0.62-2.57-2.13-2.57-3.8V41.58c0-3.15,3.42-5.13,6.15-3.55L498.5,313.18
  ...
  <div class="search">
    <form action="" method="post">
      ...
      <button id="bb" class="btn-search">Recherche</button>
    </form>
  </div>
  <?php
  $metier = "developpeur web";
  $sql = "SELECT idcompetence FROM metier_competence WHERE nom_metier LIKE :metier;";
  ...
  foreach ($results as $item) {
    $rest = substr((implode(",", $item)),  0, 1);
    $resultstring = Underskill::findById($rest);
  }
