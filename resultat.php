...
$sql = "INSERT INTO utilisateurs (nom,prenom,finish_at) VALUES (:nom,:prenom,:date)";
...
if (isset($_GET["nom"]) && $_GET["prenom"]) {
    ...
    $_SESSION["datefinish"]= $date;

    $query->execute();
    header('Location: assets/core/generatepdf.php');
}
...
<main id="skill">
    <div class="logoS">
        ...
        <div class="title">
            ...
            <h2>Resultat / Impression</h2>
        </div>
    </div>
    <form action="" method="get" class="formresultat">
        <input type="text" name="nom" autocomplete="off" placeholder="Nom">
        <input type="text" name="prenom" autocomplete="off" placeholder="Prénom">
        <button class="btn-search" id="buttonprintpdf">Valider</button>
    </form>
</main>
